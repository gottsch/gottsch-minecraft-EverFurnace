...
public interface IEverFurnaceBlockEntity {
    ...
    long  everFurnace_1_18_2$getLastGameTime();
    void  everFurnace_1_18_2$setLastGameTime(long gameTime);

    int   everFurnace_1_18_2$getPendingNotification();
    void  everFurnace_1_18_2$setPendingNotification(int count);

    long  everFurnace_1_18_2$getLastNotificationTime();
    void  everFurnace_1_18_2$setLastNotificationTime(long gameTime);

    float everFurnace_1_18_2$getPendingXp();
    void  everFurnace_1_18_2$setPendingXp(float xp);
}
